...
def test_different_confidence_levels(model, image_path):
    ...
    confidence_levels = [20, 30, 40, 50, 60, 70]
...
def main():
    ...
    image_files = ["image0.png", "image1.png", "image2.png", "image3.png"]
    ...
    for image_file in image_files:
        if os.path.exists(image_file):
            ...
            # Save result
            output_name = f"improved_{image_file}"
            ...
            ax1.set_title(f"Original: {image_file}")
            ax1.axis('off')
